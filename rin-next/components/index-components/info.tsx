  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text align="center" size="lg">
          Rin is designed to serve as a base image, so developers can use Rin to
          build features on top of it. In fact,{" "}
          <Anchor
            component={NextLink}
    ...
    >
      ...
      >
        ...
        <Text align="center" size="lg">
          ...
          bots, which many if not all are closed source. Ultimately, you as the
